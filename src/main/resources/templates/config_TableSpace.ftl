...
<html lang="en">  
 <head>
	...
	<script type="text/javascript" src="../js/config_TableSpace.js"></script>
          ...
          <div class="base-opt">
             ...
             <div class="col-md-6">
	             <div class="base-opt-qry">
	                <input class="base-opt-qry-txt" type="text" placeholder="搜索表空间名称" id="tableSpaceName"><img src="../images/icon_search.png"/></input>
          ...
          <div class="base-label">
             <div class="col-md-3">
                <div class="base-label-left">
                    ...
                    <span><span id="navBtn"></span>表空间配置列表(<span id="totalnum">0</span>)</span>
                </div>
             </div>
             <div class="col-md-9">
      ...
      <div class="foundaods pa">
        <div class="ods_content">
            ...
            <div class="dska">
                ...
                <div class="conduct-ods"> <div class="conduct-ods1">表空间数据源</div><div class="conduct-ods2 dataSource"></div></div>
		            ...
		            <div class="dskaadd" style="height: 200px;">
                    		<div class="found_mc">
                        		<div class="form-group form-group-lg">
		                                ...
		                                <label class="col-sm-6 control-label" style="padding-left:0;" for="fileIp"><span class="bixuan">*</span>表空间名称</label>
		                                <input type="hidden" id="tableConfigId"/>
		                                <input  type="text" maxlength="16" class="form-control required validateName validateJobName" id="tableSpaceName" style="height:30px;width: 222px; padding:0 5px;" placeholder="请输入...">
		                                <label class="error_name error" style=" display: block;"></label>
                            		 </div>
                            		  <div class="col-sm-5" style="width: 248px;float: right;">
		                                <label class="col-sm-6 control-label" style="padding-left:0;width: 200px;" for="filePath"><span class="bixuan">*</span>表空间数据源</label>
		            ...
		            <div class="dskaadd" style="height: 200px;">
                            ...
                            <div class="found_mc">
                        		<div class="form-group form-group-lg">
		                                ...
		                                <label class="col-sm-6 control-label" style="padding-left:0;width: 200px;" for="threshold"><span class="bixuan">*</span>阈值(单位：G)</label>
		                                <input type="text" maxlength="1000" class="form-control required validateName validateJobName" id="threshold" style="height:30px;width:476px ; padding:0 5px;" placeholder="请输入..."></input>
		                                <label class="error_name error" style=" display: block;"></label>
                            		 </div>
                                </div>
                            </div>
                             <div class="found_mc">
                        		<div class="form-group form-group-lg">
                           			 <div class="col-sm-5" style="width:573px;">
		                                <label class="col-sm-6 control-label" style="padding-left:0;" for="creator"><span class="bixuan">*</span>创建人 </label>
		                                <input rows="3"  type="text" maxlength="1000" class="form-control required validateName validateJobName" id="creator" style="height:30px;width:476px ; padding:0 5px;" placeholder="请输入..."></input>
		                                <label class="error_name error" style=" display: block;"></label>
                            		 </div>
                                </div>
                           	 </div>
