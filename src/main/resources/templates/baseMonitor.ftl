        ...
        <div class="base-opt">
            ...
            <div class="col-md-6">
                <div class="base-opt-qry">
                    ...
                    <input class="base-opt-qry-txt" type="text" placeholder="搜索接口名称" id="interName"><img
            ...
            <div class="col-md-9">
                <div class="base-label-right">
                    <ul>
                        ...
                        <li><img src="./images/icon_i.png"/><span>加载失败</span>(<span id="fail" class="spanclass">0</span>条)
                        </li>
